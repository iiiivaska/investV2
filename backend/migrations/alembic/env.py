...
alembic_path = os.path.dirname(current_path)
backend_path = os.path.dirname(alembic_path)
...
# Корректируем путь к базе данных, если запускаем из директории migrations
database_url = settings.database_url
if database_url.startswith("sqlite:///./migrations/"):
    # Если запускаем из migrations/, то путь должен быть относительно текущей директории
